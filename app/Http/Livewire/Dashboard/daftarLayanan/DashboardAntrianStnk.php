...
class DashboardAntrianStnk extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.dashboard.daftar-layanan.dashboard-antrian-stnk', [
            'stnk' => Antrian::where('layanan', 'stnk')->where('is_call', 0)->paginate(10)
        ]);
    }
}
