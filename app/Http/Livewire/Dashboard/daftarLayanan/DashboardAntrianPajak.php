...
class DashboardAntrianPajak extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.dashboard.daftar-layanan.dashboard-antrian-pajak', [
            'pajak' => Antrian::where('layanan', 'pajak')->where('is_call', 0)->paginate(10)
        ]);
    }
}
