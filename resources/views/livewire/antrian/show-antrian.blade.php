<section id="antrian" class="d-flex align-items-center">
    <div class="container" style="margin-top: 150px">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="mb-3">
                    <select class="form-select" wire:model="layanan">
                        <option value="">Sortir Berdasarkan Pelayanan</option>
                        <option value="umum">Bayar Pajak</option>
                        <option value="gigi">Penerbitan STNK</option>
                        <option value="tht">Penerbitan BPKB</option>
                        <option value="lansia & disabilitas">Pengujian Kendaraan</option>
                    </select>
                </div>
            </div>
        </div>
