...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="/assetsDashboard/img/profil.png" alt="Profile" class="rounded-circle">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/dashboard/antrian/bpkb">
                            <i class="bi bi-circle"></i><span>BPKB</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/stnk">
                            <i class="bi bi-circle"></i><span>STNK</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/pajak">
                            <i class="bi bi-circle"></i><span>Pajak Kendaraan</span>
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard/antrian/uji">
                            <i class="bi bi-circle"></i><span>Uji Kendaraan</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('dashboard.feedback.index') }}">
                    <i class="bx bx-task"></i>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>E-Riau SAMSAT</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
